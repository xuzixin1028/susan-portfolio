      ...
      <div style={{ flex: 1, height: isMobile ? 'auto' : '100%', minHeight: isMobile ? '600px' : undefined, position: 'relative', overflow: isMobile ? 'visible' : 'hidden', padding: isMobile ? '24px 16px 40px' : undefined }}>
        ...
        {isMobile ? (
          ...
          <>
            ...
            {/* Yami sticker */}
            <div style={{ position: 'absolute', top: '3%', left: '55%', width: '80px', zIndex: 2, transform: 'rotate(4deg)', pointerEvents: 'none' }}>
            ...
            {/* Notion sticker */}
            <div style={{ position: 'absolute', top: '82%', left: '50%', width: '88px', zIndex: 2, transform: 'rotate(-3deg)', pointerEvents: 'none' }}>
